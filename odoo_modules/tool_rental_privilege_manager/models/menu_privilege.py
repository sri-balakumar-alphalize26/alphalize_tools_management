        ...
        try:
            ...
            try:
                ...
                cr.execute("""
                    ...
                    FROM role_menu_visibility_rental rmv
                    JOIN privilege_role_rental pr ON pr.id = rmv.role_id
                ...
                # c) Apps special menu
                cr.execute("""
                    SELECT 1 FROM special_menu_privilege_rental
...
class SpecialMenuPrivilege(models.Model):
    _name = 'special.menu.privilege.rental'
    ...
    def get_hidden_special_menus(self):
        ...
        try:
            ...
            cr.execute("""
                ...
                WHERE rel.uid = %s
                  AND imd.module = 'tool_rental_privilege_manager'
            ...
            if cr.fetchone():
                return []
            cr.execute("""
                SELECT menu_key FROM special_menu_privilege_rental
