...
class UserPrivilege(models.Model):
    ...
    def get_user_privilege(self, model_name, user_id=None):
        ...
        if user.has_group('tool_rental_privilege_manager.group_privilege_apps_manager'):
            return None
        ...
        role_privs = self.env['privilege.role.rental'].get_role_privileges(model_name, user_id)
        if role_privs:
            return role_privs
        ...
        try:
            ...
            if model_rec:
                mp_line = self.env['module.privilege.line.rental'].sudo().search([
                    ('user_id', '=', user_id),
