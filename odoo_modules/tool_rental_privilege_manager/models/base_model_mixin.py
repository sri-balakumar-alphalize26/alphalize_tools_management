...
# user_privilege_manager_ and tool_rental_privilege_manager are installed
# side-by-side, neither module's privilege tables are recursively checked.
EXCLUDED_MODELS = {
    # Apps-build privilege models (.app suffix)
    'user.privilege.rental', 'module.privilege.rental', 'module.privilege.line.rental',
    'menu.privilege.rental', 'privilege.role.rental', 'role.privilege.line.rental',
    'role.menu.visibility.rental', 'role.module.visibility.rental', 'module.visibility.rental',
    'special.menu.privilege.rental', 'app.feature.rental', 'app.feature.visibility.rental',
    'role.app.feature.visibility.rental',
...
def _get_priv(env, model_name):
    ...
    try:
        with _Bypass():
            return env['user.privilege.rental'].get_user_privilege(model_name)
    except Exception:
        return None
